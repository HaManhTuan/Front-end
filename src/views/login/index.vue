<template>
  <div class="login-container">
    ...
    <el-dialog title="Register Account" :visible.sync="showDialog">
      <el-form :model="formRegister" class="register-form" autocomplete="on" label-position="left">
  ...
  methods: {
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          this.loading = true
          this.loginForm.is_remember = true
    ...
    async register() {
      await signup(this.formRegister).then(res => {
